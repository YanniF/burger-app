  ...
  render() {
    let form = (
      <form>
        ...
        <input className={classes.Input} type="text" name="street" placeholder="Your street name here" />
        <input className={classes.Input} type="text" name="name" placeholder="Your postal code here" />
